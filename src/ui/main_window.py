...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self) -> None:
        ...
        self._content_splitter.setStyleSheet("QSplitter::handle { background-color: rgba(255,255,255,0.06); }")
    ...
    def _setup_statusbar(self) -> None:
        ...
        self._ddl_alert_label.setStyleSheet(
            "color: #fff; background-color: #e74856; border-radius: 4px; "
    ...
    def _update_tomorrow_preview(self) -> None:
        ...
        if is_early:
            text = (
                f'{prefix}<span style="color:#ff6b6b;">需要早起</span>'
